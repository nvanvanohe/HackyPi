# Code to verify active IP's on the network using WSL and Bash
# 20-03-2024 Nohé variation for version 9.0.0
...
try:
    ...
    keyboard_layout.write(
        "for ip in {1..254};do (ping 172.29.26.$ip -c 1 -w 1 | awk 'NR==4, NR==5' | grep \"172.29.26.$ip\" | awk '{print $2}'); done"
    )
    keyboard.send(Keycode.ENTER)
    time.sleep(5)
